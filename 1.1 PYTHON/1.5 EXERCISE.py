...
import math
# Question 1: Given the 4 numbers below, fill in the code DONE!
...
# Question 2a: Use two tabs to separate the evaluated variables in the string DONE!
...
# Question 2b: Use new lines in addition to the two tabs noted above to DONE!
...
# Question 3: Use the .format method to update the line below DONE!
...
# Question 4: Use the pow function from math module to evaluate 2 to the DONE!
# power of 5, or 2^5
import math
print("2 to the power of 5 is listed below...")
print(f"{math.pow(2, 5)}")
print("-"*40)
print()

# Question 5: Use the log2 function from math module to evalute log base 2 DONE!
# of 32
print("log base 2 of 32 is listed below...")
print(f"{math.log2(32)}")
print("-"*40)
print()
